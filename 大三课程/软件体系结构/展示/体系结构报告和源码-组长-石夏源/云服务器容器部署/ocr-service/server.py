...
SERVER_ADDRESS = "172.20.0.3:8848"
...
port = int(os.getenv('OCR_SERVICE_PORT', 8090))
# 会自动获取本机ip地址
ip = get_ip()
...
def register_to_nacos():
    ...
    response = requests.post("http://172.20.0.3:8848/nacos/v1/ns/instance", data={
...
def service_beat():
    nacos_server = "http://172.20.0.3:8848/"
    namespace = "public"
